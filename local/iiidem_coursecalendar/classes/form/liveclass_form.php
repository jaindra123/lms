...
class liveclass_form extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('text', 'summary', get_string('liveclasstitle', 'local_iiidem_coursecalendar'), ['size' => 70]);
        $mform->setType('summary', PARAM_TEXT);
        $mform->addRule('summary', get_string('required'), 'required', null, 'client');

        $mform->addElement('textarea', 'description', get_string('liveclassdescription', 'local_iiidem_coursecalendar'), 'rows="4" cols="70"');
