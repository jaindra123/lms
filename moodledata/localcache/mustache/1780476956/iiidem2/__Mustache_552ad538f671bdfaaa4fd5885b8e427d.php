...
class __Mustache_552ad538f671bdfaaa4fd5885b8e427d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC868778df3393d7043fb9d675142c74c($context, $indent, $value);
    ...
    private function sectionC868778df3393d7043fb9d675142c74c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
M.util.js_pending(\'theme_iiidem2/drawers:load\');
require([\'theme_iiidem2/drawers\'], function() {
    M.util.js_complete(\'theme_iiidem2/drawers:load\');
});
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'M.util.js_pending(\'theme_iiidem2/drawers:load\');
';
                $buffer .= $indent . 'require([\'theme_iiidem2/drawers\'], function() {
';
                $buffer .= $indent . '    M.util.js_complete(\'theme_iiidem2/drawers:load\');
';
                $buffer .= $indent . '});
';
                $context->pop();
