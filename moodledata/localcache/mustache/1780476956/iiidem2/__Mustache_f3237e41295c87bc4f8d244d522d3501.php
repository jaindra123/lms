...
class __Mustache_f3237e41295c87bc4f8d244d522d3501 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <div id="region-main" class="col-12">
';
        $buffer .= $indent . '                ';
...
';
        ...
        $buffer .= $this->sectionE8adf13c69eefb191ffc7292746a0aa1($context, $indent, $value);

        return $buffer;
    }

    private function sectionE8adf13c69eefb191ffc7292746a0aa1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
M.util.js_pending(\'theme_iiidem2/loader\');
require([\'theme_iiidem2/loader\'], function() {
  M.util.js_complete(\'theme_iiidem2/loader\');
});
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'M.util.js_pending(\'theme_iiidem2/loader\');
';
                $buffer .= $indent . 'require([\'theme_iiidem2/loader\'], function() {
';
                $buffer .= $indent . '  M.util.js_complete(\'theme_iiidem2/loader\');
';
                $buffer .= $indent . '});
';
                $context->pop();
