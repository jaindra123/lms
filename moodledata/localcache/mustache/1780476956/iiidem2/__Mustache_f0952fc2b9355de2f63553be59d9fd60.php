...
class __Mustache_f0952fc2b9355de2f63553be59d9fd60 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        if ($parent = $this->mustache->loadPartial('theme_iiidem2/drawer')) {
            $context->pushBlockContext(array(
                'id' => array($this, 'blockFfe0594df220a5dccde1d389a3fbbe3b'),
                ...
                'drawerheading' => array($this, 'block02c7f35cc8f4fd4935515ac2700f58cc'),
    ...
    private function sectionA64f0cb7e6e9ce5ffa12476ca05765a9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function blockFfe0594df220a5dccde1d389a3fbbe3b($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . 'theme_iiidem2-drawers-primary';
    ...
    public function block02c7f35cc8f4fd4935515ac2700f58cc($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <a
';
