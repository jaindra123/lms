...
$string['apiconnectionfailed'] = 'Could not connect to Razorpay. Please try again later.';
$string['apiinvalidresponse'] = 'Received an invalid response from Razorpay.';
$string['apierror'] = 'Razorpay error: {$a}';
