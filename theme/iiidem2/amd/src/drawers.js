...
// The jQuery module is only used for interacting with iiidem2rap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_iiidem2/drawers:show}
     * @property {String} drawerShown See {@link event:theme_iiidem2/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_iiidem2/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_iiidem2/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_iiidem2/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_iiidem2/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_iiidem2/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_iiidem2/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_iiidem2/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_iiidem2/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_iiidem2/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_iiidem2/drawers:hidden',
    };
     ...
     * @returns {module:theme_iiidem2/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true, setUserPref = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_iiidem2/drawers:open');
     ...
     */
        ...
        const pendingPromise = new Pending('theme_iiidem2/drawers:close');
     ...
     *
     * @param {module:theme_iiidem2/drawers} comparisonInstance
     */
