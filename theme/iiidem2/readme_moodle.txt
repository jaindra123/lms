...
* remove folder theme/iiidem2/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/iiidem2/scss/bootstrap
...
* comment out this line in theme/iiidem2/scss/_print.scss
    @page {
...
* remove folder theme/iiidem2/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/iiidem2/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/iiidem2/amd/src
* edit theme/iiidem2/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/iiidem2 run "grunt amd" to compile the bootstrap JS
* in folder theme/iiidem2 run "grunt css" to compile scss
