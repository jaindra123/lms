...
class core_renderer extends \core_renderer {
    ...
    /**
     * Renders the "breadcrumb" for all pages in iiidem2.
     *
     * @return string the HTML for the navbar.
     */
    public function navbar(): string {
        $newnav = new \theme_iiidem2\iiidem2navbar($this->page);
    ...
    /*public function dashboard_context() {
...
*/
    ...
    public function dashboard_context(): array {
        return \theme_iiidem2_get_dashboard_context();
    }
