...
2. SCSS:
  a. Replace the files in this folder (/theme/iiidem2/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/iiidem2/scss/fontawesome.
  c. Update theme/iiidem2/thirdpartylibs.xml.
