@theme_iiidem2
Feature: Course sections selector is not available on iiidem2 theme
  ...
  Scenario Outline: Course sections selector is not available on iiidem2 theme regardless of the course format
